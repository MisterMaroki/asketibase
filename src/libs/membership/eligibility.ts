...
export const ELIGIBILITY_STATEMENT = `By proceeding you agree that you and all members are eligible for coverage based on the requirements listed above. Any false declarations may result in claim denials and policy cancellation.`;
